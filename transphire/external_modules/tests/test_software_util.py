...
class TestLoadSoftware_falcon:
    ...
    def test_load_software_get_all_files_18_returns_epus(self):
        assert software.load_software('get_all_files', 'EPU', 'Falcon', '1.8') == epu.get_all_files__1_8_falcon
    ...
    def test_load_software_get_all_files_19_returns_epus(self):
        assert software.load_software('get_all_files', 'EPU', 'Falcon', '1.9') == epu.get_all_files__1_8_falcon
...
class TestLoadSoftware_k218:
    ...
    def test_load_software_get_all_files_18_returns_epus(self):
        assert software.load_software('get_all_files', 'EPU', 'K2', '1.8') == epu.get_all_files__1_8_k2
    ...
    def test_load_software_get_all_files_19_returns_epus(self):
        assert software.load_software('get_all_files', 'EPU', 'K2', '1.9') == epu.get_all_files__1_9_k2
