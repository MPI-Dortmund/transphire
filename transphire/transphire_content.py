...
def default_general():
    ...
    items = [
        ...
        ['Rename prefix', '', str, 'Rename micrographs:True', 'PLAIN', 'Main', 'prefix for the renamed micrographs prefix_number_suffix.extension'],
        ['Rename suffix', '', str, 'Rename micrographs:True', 'PLAIN', 'Main', 'Suffix for the renamed micrographs prefix_number_suffix.extension'],
        ...
        ['Start number', '0', int, 'Increment number:False', 'PLAIN', 'Main', 'First number to use for the renaming process.'],
