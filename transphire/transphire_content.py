...
def default_motion_cor_2_v1_0_0():
    ...
    items = [
        ...
        ['-FtBin:MotionCor FtBin', '1', float, '', 'PLAIN', 'Advanced', 'Binning performed in Fourier space, default 1.0.'],
...
def default_global():
    items = [
        ...
        ['MotionCor FtBin', '1.0', float, '', 'PLAIN', 'Main', 'Binning performed in Fourier space, default 1.0.'],
